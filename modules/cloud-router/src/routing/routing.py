...
# Adjusting imports to refer back to emulator for shared structures
# In a future phase, these might be moved to a 'shared' or 'common' module.
...
class Routing(ABC):
    """
    Extracted from emulator. This is a base class for routing strategies.
    Each newly implemented routing strategy should inherit from this class.
    """
